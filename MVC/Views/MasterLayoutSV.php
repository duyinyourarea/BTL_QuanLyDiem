   ...
   <table style="width: 100%;margin-top: 2px;">
      <tr>
         ...
         <td style="align-items: end;width: 150px;border-radius: 15px;background-color: #56a4fe;text-align: center;">
            <span style="color: aliceblue;"><a
                  href="http://localhost/BTL_QuanLyDiem/Home/TrangchuSV/<?php echo $data['masinhvien'] ?>"
         ...
         <div class="accordion" id="accordionExample">
            <div class="card" style="border: none;">
               <div class="card-header" id="headingOne" style="border-radius: 15px; ">
                  <h6 class="mb-0">
                     <a
                        href="http://localhost/BTL_QuanLyDiem/TraCuuDiemSinhVien/Get_data/<?php echo $data['masinhvien'] ?>"><b
                           style="position: relative; left: 15px; top: -2px; color: black;">Tra cứu điểm</b></a>
                  </h6>
               </div>
            </div>
            ...
            <div class="card" style="border: none;">
               <div class="card-header" id="headingTwo" style="border-radius: 15px;">
                  <h6 class="mb-0">
                     <a
                        href="http://localhost/BTL_QuanLyDiem/TraCuuDiemTongHopSinhVien/Get_data/<?php echo $data['masinhvien'] ?>"><b
                           style="position: relative; left: 15px; top: -2px; color: black;">Tra cứu điểm tổng
                           hợp</b></a>
                  </h6>
               </div>
            </div>
