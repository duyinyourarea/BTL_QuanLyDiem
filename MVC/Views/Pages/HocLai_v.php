...
<head>
    ...
    <title>Thống kê sinh viên học lại</title>
</head>
...
<body>
    ...
    <table style="text-align: center; margin-top: 15px;" align="center">
        <tr>
            <form action="http://localhost/BTL_QuanLyDiem/ThongKeSinhVien/Timkiem_hoclai" method="post">
                <td>
            ...
            <td><a href="http://localhost/BTL_QuanLyDiem/ThongKeSinhVien/ExportExcel_hoclai"><button class="btn btn-outline-primary" name="btnExportExcel" style="margin-left: 5px;">ExportExcel</button></a></td>
        </tr>
    </table>
    <?php
    ...
    ?>
        <h5 style="text-align: center;margin-top: 20px;">TỔNG SỐ SINH VIÊN HỌC LẠI CÁC MÔN: <?php echo $row_count['count']; ?></h5>
        <h3 style="text-align: center;">DANH SÁCH CHI TIẾT SINH VIÊN HỌC LẠI</h3>
        <table class="table table-bordered table-hover" style="text-align: center;">
            ...
            <tbody>
                ...
                <?php
                if (isset($data['dulieu_hoclai']) && $data['dulieu_hoclai'] != null) {
                    $i = 1;
                    while ($row = mysqli_fetch_array($data['dulieu_hoclai'])) {
                ?>
                        <tr>
                            <td>
                                <?php echo $i++ ?>
