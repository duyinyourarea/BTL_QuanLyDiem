...
<body>
   <form action="http://localhost/BTL_QuanLyDiem/DanhSachKhoa/Timkiem" method="post">
      <table style="width: 100%;">
         <tr>
            <td style="width: 64%;"><a href=""><button class="btn btn-outline-secondary" name="btnThemkhoa" style="margin: 5px;">Thêm khoa</button></a></td>
            <td>
               <form>
            ...
            ?>
                  <tr>
                     ...
                     <td>
                        ...
                        <a href="http://localhost/BTL_QuanLyDiem/DanhSachKhoa/Xoa/<?php echo $row['makhoa'] ?>"><img class="icon" src="Public/Images/trash.png" alt="trash"></a>
                     </td>
                  </tr>
            <?php
               }
