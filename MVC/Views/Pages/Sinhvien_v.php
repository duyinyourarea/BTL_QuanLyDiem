...
<body>
    ...
    <table style="width: 100%;">
        <tr>
            <td style="width: 64%;"><a href="http://localhost/BTL_QuanLyDiem/DanhSachSinhVien/Them"><button class="btn btn-outline-success" name="btnThemsinhvien" style="margin: 5px;">Thêm
